...
int main()
{
    ...
    for (size_t len = 0; len <= 16; len++) {
        std::cerr << "Testing random string length=" << len << std::endl;
        do_random_ab_string_test(len);
    }
}
